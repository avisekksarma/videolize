...
if selected == "Home":
    ...
    # utility functions
    def display_video():
        video_file = open('example_videos/star-lifecycle.mp4', 'rb')
    ...
    with main_col1:
        ...
        for i in range(st.session_state.c):
            ...
            st.text_input(f"Scene {i+1}", key=f"text{i+1}")
